...
$pdf->SetTitle('Reporte de Categorias');
...
$pdf->Cell(100,6,'LISTA DE Categorias',0,0,'C');
...
$sqlTrabajadores = ("SELECT id_categoria as Nro,nombre_categoria as Categoria, descripcion_categoria as Descripcion,
logo_categoria as Logo,estado_categoria as Estado 
FROM categorias order by Estado, Categoria");

$query = mysqli_query($conexion, $sqlTrabajadores);

while($dataRow = mysqli_fetch_array($query)) {
    $pdf->Cell(55,6,($dataRow['Categoria']),1,0,'C');
...
//$pdf->AddPage();
$pdf->Output('Reporte_Categorias_'.date('d_m_y').'.pdf', 'I');
