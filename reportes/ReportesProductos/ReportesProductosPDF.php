...
$pdf->Cell(55,6,'Marca',1,0,'C',1);
$pdf->Cell(55,6,'Descripcion',1,0,'C',1);
$pdf->Cell(55,6,'Categoria',1,1,'C',1);
...
$sqlTrabajadores = ("SELECT pr.id_prod as id,nombre_prod,pr.imagen_prod,pr.precio_unit_compra,marcas.nombre_marca,                        
...
while($dataRow = mysqli_fetch_array($query)) {
    $pdf->Cell(40,6,($dataRow['nombre_prod']),1,0,'C');
    //$pdf->Cell(40,6,($dataRow['imagen_prod']),1,0,'C');
    $pdf->Cell(55,6,($dataRow['precio_unit_compra']),1,0,'C');
    $pdf->Cell(55,6,($dataRow['nombre_marca']),1,0,'C');
    $pdf->Cell(55,6,($dataRow['descripcion_prod']),1,0,'C');
    $pdf->Cell(55,6,($dataRow['nombre_categoria']),1,1,'C');

}

//$pdf->AddPage();
$pdf->Output('ReporteProductos'.date('d_m_y').'.pdf', 'I');
