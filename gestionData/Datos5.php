...
<body>
  <div class="row">
    ...
    <div class="col-10">
      ...
      //query
      $ejecutarConsulta = $conexionolap->query("SELECT T.descripcion nombre, `cant_redes` total FROM `dbo.ventas` 
              INNER JOIN `dbo.redes` as T ON `dbo.ventas`.`Redes_id_olap` = T.id_olap 
              ORDER BY `cant_redes` DESC LIMIT 10;
              ");
      ...
      <div class="container">
        <br><br>
        <h1>Consulta 5: Productos mas vendidos por cantidad de la categoria Redes</h1>
