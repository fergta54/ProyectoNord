...
<body>
  <div class="row">
    ...
    <div class="col-10">
      ...
      //query
      $ejecutarConsulta = $conexionolap->query("SELECT T.descripcion nombre, `cant_cables` total FROM `dbo.ventas` INNER JOIN `dbo.cables` as T ON `dbo.ventas`.`Cables_id_olap` = T.id_olap 
              ORDER BY `cant_cables` DESC LIMIT 10;
              ");
      ...
      <div class="container">
        <br><br>
        <h1>Consulta 10: Productos mas vendidos por cantidad de la categoria Cables</h1>
