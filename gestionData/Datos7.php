...
<body>
  <div class="row">
    ...
    <div class="col-10">
      ...
      //query
      $ejecutarConsulta = $conexionolap->query("SELECT T.descripcion nombre, `cant_electricos` total FROM `dbo.ventas` INNER JOIN `dbo.electricos` as T ON `dbo.ventas`.`Electricos_id_olap` = T.id_olap 
              ORDER BY `cant_electricos` DESC LIMIT 10;
              ");
      ...
      foreach ($ejecutarConsulta as $p) {
        ...
        $pastel_temp[] = array('v' => (float) $p['total']);
      ...
      <div class="container">
        <br><br>
        <h1>Consulta 7: Productos mas vendidos por cantidad de la categoria Electricos</h1>
