...
<body>
  <div class="row">
    ...
    <div class="col-10">
      ...
      //query
      $ejecutarConsulta = $conexionolap->query("SELECT T.descripcion nombre, `cant_aparatos` total FROM `dbo.ventas` INNER JOIN `dbo.aparatos` as T ON `dbo.ventas`.`Aparatos_id_olap` = T.id_olap 
              ORDER BY `cant_aparatos` DESC LIMIT 10;
              ");
      ...
      <div class="container">
        <br><br>
        <h1>Consulta 9: Productos mas vendidos por cantidad de la categoria Aparatos</h1>
