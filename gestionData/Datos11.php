...
<body>
  <div class="row">
    ...
    <div class="col-10">
      ...
      //query
      $ejecutarConsulta = $conexionolap->query("SELECT T.descripcion nombre, `cant_otros` total FROM `dbo.ventas` INNER JOIN `dbo.otros` as T ON `dbo.ventas`.`Otros_id_olap` = T.id_olap 
              ORDER BY `cant_otros` DESC LIMIT 10;
              ");
      ...
      <div class="container">
        <br><br>
        <h1>Consulta 11: Productos mas vendidos por cantidad de la categoria Otros</h1>
